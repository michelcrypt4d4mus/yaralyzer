...
* Add `__suppress_decodes_table` / `__suppress_decoding_attempts` to filenames if those options are in use
* Get rid of `args._standalone_mode`
* Move `ask_to_proceed()` from pdfalyzer
