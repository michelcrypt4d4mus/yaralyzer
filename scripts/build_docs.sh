...
lazydocs --output-path docs/api \
         ...
         --ignored-modules="dict_helper,list_helper,helpers.collections_helper,helpers.list_helper,yaralyzer.util.helpers.dict_helper,yaralyzer.util.helpers.list_helper" \
         "$YARALYZER_PKG" \
