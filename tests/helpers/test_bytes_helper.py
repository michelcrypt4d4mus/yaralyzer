from yaralyzer.helpers.bytes_helper import get_bytes_info_for_file, clean_byte_string
...
def test_get_bytes_info(tulips_yara_path):
    bytes_info = get_bytes_info_for_file(tulips_yara_path)
