...
def test_compute_file_hashes(tulips_yara_path):
    ...
    assert bytes_info.size == 333
    assert bytes_info.md5 == '1B710FB4A0FA3717F22BB6CBBF6FD467'
    assert bytes_info.sha1 == '24CEEDEB1457C1AB2D46DB58B47F14FBE3C2A7B5'
    assert bytes_info.sha256 == 'E34735D74DD6AFA882B9EE1426A00CCA36AEAB07C100D86558BC78CC3965A935'
